...
package org.keycloak.telekom;

import org.keycloak.telekom.readonly.PropertyFileUserStorageProvider;
import org.keycloak.telekom.util.StorageManager;
...
import org.keycloak.telekom.page.ConsolePage;
import org.keycloak.telekom.writeable.PropertyFileUserStorageProviderFactory;
...
public class ArquillianSimpleStorageTest {
    ...
    public static Archive<?> createTestArchive() throws IOException {
        return ShrinkWrap.create(JavaArchive.class, "user-storage-simple-example.jar")
                .addClasses(
                        ...
                        PropertyFileUserStorageProvider.class,
                        org.keycloak.telekom.readonly.PropertyFileUserStorageProviderFactory.class,
                        org.keycloak.telekom.writeable.PropertyFileUserStorageProvider.class,
    ...
    public void testUserWritableFederationStorage() throws MalformedURLException, InterruptedException {
        try {
            ...
            StorageManager.addUser("malcom", "butler");

            loginPage.login("admin", "admin");
            consolePage.selectWritableStorage();
            consolePage.setFileStoragePath(StorageManager.getPropertyFile());
            consolePage.save();
            ...
            StorageManager.addUser("rob", "gronkowski");
